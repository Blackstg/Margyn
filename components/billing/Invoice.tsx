// Composant Facture partagé (page interne /[brand]/billing + page publique /facture).
...
export function Invoice({ order, settings, mode }: { order: ShopifyOrder; settings: InvoiceSettings | null; mode: 'facture' | 'avoir' }) {
